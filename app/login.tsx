...
function Login() {
  ...
  return (
    <ImageBackground source={require('@/assets/images/login_background.png')} style={styles.background}>
        ...
        <Text style={[styles.welcomeText, globalFont.Nunito]}>Welcome back!</Text>
        ...
        <TouchableOpacity style={styles.loginButton} onPress={handleSubmit(onSubmit)}>
          <Text style={[styles.loginButtonText,globalFont.Nunito]}>Login</Text>
        </TouchableOpacity>

        <Button title="Log In" onPress={handleSubmit(onSubmit)} />
       <Text style={{ textAlign: "center" }}>Don't have an account? <Link href="signup">Sign Up</Link>
       </Text>
      </View>
    </ImageBackground>
  );
